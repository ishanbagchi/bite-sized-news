...
const Navbar = () => {
	return (
		<nav className="navbar">
			...
			<div className="absolute bg-white w-full left-0 top-full mt-0.5 border-b border-grey/50 py-4 px-[5vw] md:border-0 md:block md:relative md:inset-0 md:p-0 md:w-auto">
				<input
					type="search"
					placeholder="Search"
